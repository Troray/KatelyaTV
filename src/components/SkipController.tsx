                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-[166px] px-3 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-center"
                      placeholder="0:00"
                    />
